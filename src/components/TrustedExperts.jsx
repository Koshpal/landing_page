  ...
  return (
    <section className="py-20 md:py-24 bg-white overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center gap-6 md:gap-8 overflow-visible relative">
          {experts.map((expert) => (
            <div
              key={expert.name}
              className={`${expert.bgColor} group rounded-3xl p-6 text-center flex flex-col relative overflow-hidden transition-all duration-500 ease-in-out lg:hover:-translate-y-2 lg:hover:z-10 lg:hover:overflow-visible w-[calc(50%-0.75rem)] md:w-[calc(50%-1rem)] lg:w-[240px] lg:hover:w-[400px] lg:flex-shrink-0 min-h-[380px] lg:h-[420px]`}
            >
        ...
        <div className="mt-16 text-center">
          <button
            className="px-8 py-4  font-semibold rounded-full shadow-lg transition-transform duration-300 hover:scale-105 text-white"
            style={{
              background: 'linear-gradient(to right, #4A72FF, #2743A8)',
              color: 'white'
            }}
          >
            View our Advisors
